...
input[23:0] sys_wraddr;		// 写SDRAM时地址暂存器，(bit21-20)L-Bank地址:(bit19-8)为行地址，(bit7-0)为列地址 
input[23:0] sys_rdaddr;		// 读SDRAM时地址暂存器，(bit21-20)L-Bank地址:(bit19-8)为行地址，(bit7-0)为列地址 
...
input[9:0] sdwr_byte;		//突发写SDRAM字节数（1-512个）
input[9:0] sdrd_byte;		//突发读SDRAM字节数（1-512个）
